...
const App: React.FC = () => {
    ...
    return (
        <div className="min-h-screen font-sans flex flex-col relative overflow-x-hidden bg-background text-foreground">
            {showSettings && (
