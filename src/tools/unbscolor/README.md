# UNBSCOLOR — Integração com o Hub

## Como clonar e integrar

1. Clone o repositório UNBSCOLOR
2. Copie o conteúdo de `src/` para `src/tools/unbscolor/`
...
7. Se o app tiver rotas internas, use `useNavigate` e paths relativos — o hub já monta em `/unbscolor/*`
