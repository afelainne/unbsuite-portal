...
const TOOLS: Tool[] = [
  ...
  { name: "UNBSFORMAT", tagline: "Formatos de impressão", copy: "Sangria, margem de segurança e grade de colunas, com exportação em PDF pronto para a gráfica.", status: "Novo", path: "/unbsformat", icon: FileText, keywords: "formato sangria bleed margem impressao grafica a4 a3 cartao colunas pdf" },
